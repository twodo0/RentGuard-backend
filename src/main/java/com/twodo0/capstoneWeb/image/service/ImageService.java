package com.twodo0.capstoneWeb.image.service;

import com.twodo0.capstoneWeb.common.config.MinioProperties;
import com.twodo0.capstoneWeb.image.domain.ImageMeta;
import com.twodo0.capstoneWeb.common.port.ObjectStoragePort;
import com.twodo0.capstoneWeb.image.repository.ImageRepository;
import com.twodo0.capstoneWeb.common.util.StorageKeyFactory;
import com.twodo0.capstoneWeb.common.util.ImageSizeDetector;
...
public class ImageService {
    ...
    public ImageMeta upload(MultipartFile file) {
        try {
            ...
            Dimension dim = ImageSizeDetector.detect(bytes);
            Integer width = (dim != null) ? dim.width : null;
            Integer height = (dim != null) ? dim.height : null;

            if(width == null || height == null) {
                log.warn("Image size NOT detected. name = {}, ct = {}, bytes = {}",
                        file.getOriginalFilename(), ct, bytes.length);
            } else {

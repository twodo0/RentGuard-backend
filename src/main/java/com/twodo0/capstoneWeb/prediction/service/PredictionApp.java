...
import com.twodo0.capstoneWeb.prediction.http.InferencePort;
...
import com.twodo0.capstoneWeb.prediction.mapper.FastApiMapper;
...
public class PredictionApp { // 실제로 사진을 저장하고, FastAPI를 호출하는 서비스
    ...
    public Long runAndSave(Long imageId, Double yoloThreshold){
        ...
        //추론 결과 + heatmapId 반환
        FastApiPredictRes res = fastApiAdapter.predictByUrl(rawUrl, yoloThreshold, heatmapUploadUrl);
